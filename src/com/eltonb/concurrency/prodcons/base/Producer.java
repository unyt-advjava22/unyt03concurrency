...
package com.eltonb.concurrency.prodcons.base;
...
public class Producer implements Runnable
{
   ...
   public Producer(Buffer sharedLocation) {
      this(sharedLocation, 3000);
   }

   public Producer(Buffer sharedLocation, int maxSleepMillis) {
   ...
   public void run()                             
   {
      ...
      for (int count = 1; count <= 10; count++)
      {
         ...
         {
            if(maxSleepMillis > 0)
               Thread.sleep(generator.nextInt(maxSleepMillis)); // random sleep
